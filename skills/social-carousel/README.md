...
[![social-carousel](https://img.shields.io/github/v/release/diegoclair/harness?filter=carousel-v*&color=11C47E&label=social-carousel)](https://github.com/diegoclair/harness/releases?q=tag%3Acarousel-v)
...
```bash
curl -fsSL https://raw.githubusercontent.com/diegoclair/harness/main/skills/social-carousel/install/install.sh | bash
```
...
```bash
git clone https://github.com/diegoclair/harness.git && cd skills/social-carousel
