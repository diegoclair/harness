# install.ps1 — installs the quality-gate skill on Windows.
#
...
# skill name to it.
#
#   iwr -useb https://raw.githubusercontent.com/diegoclair/harness/main/skills/quality-gate/install/install.ps1 | iex
...
try {
    ...
    & $Bootstrap install quality-gate
    exit $LASTEXITCODE
}
finally {
